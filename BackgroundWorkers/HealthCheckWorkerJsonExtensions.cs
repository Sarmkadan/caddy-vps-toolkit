...
namespace CaddyVpsToolkit.BackgroundWorkers
{
    ...
    public static class HealthCheckWorkerJsonExtensions
    {
        ...
        /// <summary>
        /// Converts a <see cref="HealthCheckWorker"/> instance to its JSON representation.
        /// </summary>
        /// <param name="value">The worker instance to serialize.</param>
        /// <param name="indented">Whether to format the JSON with indentation for readability.</param>
        /// <returns>A JSON string representing the worker instance.</returns>
        ...
        /// <summary>
        /// Parses a JSON string to create a <see cref="HealthCheckWorker"/> instance.
        /// </summary>
        /// <param name="json">The JSON string to deserialize.</param>
        /// <returns>A <see cref="HealthCheckWorker"/> instance if successful; otherwise, null.</returns>
        ...
        public static HealthCheckWorker? FromJson(string json)
        {
            ...
            return JsonSerializer.Deserialize<HealthCheckWorker>(json, _jsonSerializerOptions);
        }

        /// <summary>
        /// Attempts to parse a JSON string to create a <see cref="HealthCheckWorker"/> instance.
        /// </summary>
        /// <param name="json">The JSON string to deserialize.</param>
        ...
        public static bool TryFromJson(string json, out HealthCheckWorker? value)
        {
            ...
            try
            {
                value = JsonSerializer.Deserialize<HealthCheckWorker>(json, _jsonSerializerOptions);
                return true;
            }
            catch (JsonException)
            {
